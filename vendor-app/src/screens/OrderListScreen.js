...
/**
 * The vendor's home: every incoming order, filtered by where it sits in the
 * lifecycle. Pull-to-refresh rather than polling — a shop counter runs on a
...
export default function OrderListScreen({ navigation }) {
  ...
  const openOrder = useCallback(
    (orderId) => navigation.navigate('OrderDetail', { orderId }),
    [navigation]
  );
